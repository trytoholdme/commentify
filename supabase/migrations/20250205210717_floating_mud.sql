...
BEGIN
  ...
  -- Update profile
  UPDATE profiles 
  SET name = admin_update_user.name
  WHERE user_id = admin_update_user.user_id;
...
BEGIN
  ...
  -- Delete user's data
  DELETE FROM subscriptions WHERE user_id = admin_delete_user.user_id;
  DELETE FROM profiles WHERE user_id = admin_delete_user.user_id;
